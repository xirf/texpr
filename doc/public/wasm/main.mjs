...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _261: (o, p, v) => o[p] = v,
      _281: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._281(f,arguments.length,x0) }),
      _282: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._282(f,arguments.length,x0,x1) }),
      _283: x0 => x0.random(),
